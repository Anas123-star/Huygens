<!-- Modal -->
<div class="modal fade" id="form_choose_department_ser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="choose_department_ser_form" onsubmit="return false">
